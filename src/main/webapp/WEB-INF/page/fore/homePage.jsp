...
<head>
    ...
    <title>易优购hwshop.com--理想生活上易优购</title>
</head>
<body>
<nav>
        ...
        <div class="mallSearch">
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="mallSearch-input">
                    <input class="header_search_input" type="text" name="product_name" placeholder="搜索 易优购 商品/品牌/店铺"
                           maxlength="50">
    ...
    <div class="home_nav">
        ...
        <a href="${pageContext.request.contextPath}/userDetails" target="_blank">易优购会员</a>
        <a href="" target="_blank">电器城</a>
        <a href="" target="_blank">喵鲜生</a>
        <a href="" target="_blank">医药馆</a>
        <a href="" target="_blank">营业厅</a>
        <a href="" target="_blank">魅力惠</a>
        <a href="https://sale.vmall.com/huawei.html" target="_blank">华为商城</a>
    </div>
</nav>
<div class="banner">
