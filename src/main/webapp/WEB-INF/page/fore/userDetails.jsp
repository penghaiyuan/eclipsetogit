...
<head>
    ...
    <title>易优购hwshop.com - 个人中心</title>
    ...
    <div class="header">
        <div id="mallLogo">
            <a href="${pageContext.request.contextPath}"><img
                    src="${pageContext.request.contextPath}/res/images/fore/WebsiteImage/hwshopLogoA.png"><span
                    class="span_hwshopRegister">个人中心</span></a>
        </div>
    </div>
</nav>
<div class="content">
